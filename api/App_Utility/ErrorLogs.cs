...
namespace api.App_Utility
{
    public class ErrorLogs
    {
        ...
        {
            string basePath = HttpContext.Current.Server.MapPath("~/Logs/Error/" + DateTime.Now.ToString("yyyyMM"));
            string filePath = HttpContext.Current.Server.MapPath("~/Logs/Error/" + DateTime.Now.ToString("yyyyMM") + @"/ERROR_" + DateTime.Now.ToString("yyyyMMdd") + ".txt");
